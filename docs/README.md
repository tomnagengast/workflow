...
Guides for using and developing `workflow`. Start with install, then getting
started.

| Guide | What it covers |
| --- | --- |
| [install.md](install.md) | Supported platforms, Homebrew and from-source install, verification. |
